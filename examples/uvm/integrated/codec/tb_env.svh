...
class tb_env extends uvm_env;
   ...
   function void phase_ended(uvm_phase phase);
      ...
      if (goto != null) begin
         if (goto.get_name() != "report" &&
             goto.get_name() != "reset") begin
            `uvm_fatal("ENV/BADJMP", $sformatf("Environment does not support jumping to phase %s from phase %s. Only jumping to \"reset\" or \"report\" is supported",
